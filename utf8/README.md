...
```
Processed to SVG, with garishly colorful CSS styling from
[`embed:palette/bold.css`](./css/palette/bold.css):

![XXX missing local SVG](./_README/dataflow.bold.svg)

Processed to SVG, with unobtrusive colors from
[`embed:palette/earth.css`](./css/palette/earth.css):
